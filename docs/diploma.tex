...
\end{minted}
        ...
        Ob implementaciji omejevanja števila rezultatov s pomočjo ukazov `limit` in `offset` moramo poskrbeti za časovno optimalno izvedbo poizvedbe, saj iz vidika uporabnika relacijskega sistema pričakujemo, da z dodatkom ukaza `limit` čas izvajanja skrajša.
...
\end{minted}
        ...
        \subsection{Algoirtem poizvedb z uporabo relaciji}
