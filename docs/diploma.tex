...
\chapter{Uvod}
    ...
    \begin{figure}[h]
        \centerline{\includegraphics[width=1\textwidth, angle=0]{webarchitecture.png}}
...
\end{minted}
    ...
    \section{Indeksiranje z uporabo B+ dreves}
        ...
        \begin{figure}[H]        
            \centerline{\includegraphics[width=0.9\textwidth, angle=0]{Bplustree.png}}
        ...
        %Ne glede na razlike, pa lahko preverjanje ob času izvajanja %vstavljanja s pomočjo C++ prevajalnika odstranimo, saj z uporabo {\tt %constexpr} omogočimo, da prevajalnik vstavljanje prilagodi že pred %samim izvajanjem.
