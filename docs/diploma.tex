...
\end{code}
    ...
    \section{Indeksiranje z uporabo B+ dreves}
        ...
        Vendar časovna zahtevnost velja le v primeru, ko sta razcep (prekoračitev velikosti vozlišča ob vstavljanju) in združevanje (spodnja prekoračitev velikosti vozlišča ob brisanju) implementirana s časovno zahtevnostjo $O(1)$ \cite{goodrich2011data}. Poleg tega pa se mora implementacija drevesa držati vseh lastnosti definiranih v razdelku~\ref{btree_rules}.
        ...
        V implementaciji B+ drevesa je ena izmed ključnih lastnosti omogočanje večkratnega shranjevanja istega ključa. Posledično rezultat iskanja predstavimo z množico $\{d_1, d_2, d_3, \ldots\}$, kjer z $d$ označujemo identifikatorje najdenih zapisov.
