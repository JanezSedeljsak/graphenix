...
\end{code}
    ...
    \section{Mehanizem shranjevanja podatkov}
        ...
        \begin{figure}[h]
                \centerline{\includegraphics[width=1\textwidth, angle=0]{struktura_entitet.png}}
...
\end{figure}
        ...
        \begin{figure}[H]
            \centerline{\includegraphics[width=0.75\textwidth, angle=0]{prvih_k_elementov.png}}
...
\end{minted}
    ...
    \begin{figure}[H]
        \centerline{\includegraphics[width=0.75\textwidth, angle=0]{queryread.png}}
...
\end{minted}
    ...
    \begin{figure}[H]
        \centerline{\includegraphics[width=0.75\textwidth, angle=0]{join.png}}
