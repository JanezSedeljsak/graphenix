...
\end{minted}
    ...
    \begin{center}
        \begin{tabular}{p{0.2\textwidth}|p{.15\textwidth}|p{.15\textwidth}|p{.15\textwidth}|p{.15\textwidth}}
          {\bf Podatkovni sistem} & {\bf 1/8000 (ms)} & {\bf Pohitritev} & {\bf 1/80 \newline (ms)} & {\bf Pohitritev} \\ \hline
          {\bf Graphenix} & \num{69.93} & \num{1}x & \num{87.15} & \num{1.12}x \\
          {\bf SQLite} & \num{0.83} & \num{66.01}x & \num{29.39} & \num{2.82}x \\
          {\bf MySQL} & \num{1.96} & \num{126.18}x & \num{91.11} & \num{3.26}x \\
        \end{tabular}
    ...
    \begin{figure}[H]
        \centerline{\includegraphics[width=0.7\textwidth, angle=0]{indexing_speedup_1000000.png}}
        \caption{Preprost primer relacijske podatkovne baze.}
        \label{vnospodatkov_index}
    \end{figure}
    ...
    \begin{figure}[H]
        \centerline{\includegraphics[width=0.7\textwidth, angle=0]{indexing_speedup_10000000.png}}
        \caption{Preprost primer relacijske podatkovne baze.}
        \label{vnospodatkov_index}
    \end{figure}
